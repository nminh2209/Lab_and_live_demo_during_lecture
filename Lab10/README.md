...
- [data/reports/detailed_lab_report.md](data/reports/detailed_lab_report.md) — full detailed lab report
- [data/reports/lab_report.md](data/reports/lab_report.md) — executive summary report
- `streamlit_app.py` — interactive walkthrough of pipeline concepts, metrics, and live Q&A
