...
LANGSMITH_API_KEY=...       # optional — traces at https://smith.langchain.com
LANGSMITH_PROJECT=multi-agent-research-lab
TAVILY_API_KEY=...          # optional — real web search (else LLM mock)
```
...
### 6. Streamlit demo (interactive showcase)
...
Mở trình duyệt để xem architecture, chạy baseline/multi-agent/benchmark, trace, và rubric.
